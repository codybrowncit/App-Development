...
public class MyActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myButton = (ImageButton)findViewById(R.id.my_button);
        ...
        myListView.setAdapter(mJSONAdapter);
    }

    private void queryBooks(String searchString) {

        // Prepare your search to be put in a URL
    ...
    private void displayWelcome() {
        ...
        // or and empty string if nothing found
...
// 9. Take what was typed into the EditText and use in search
        queryBooks(myEditText.getText().toString());
    }
    @Override
    public void onItemClick(AdapterView parent, View view, int position, long id) {
        ...
        String author = jsonObject.optJSONArray("author_name").optString(0);
